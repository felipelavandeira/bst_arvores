  ...
  if (estaVazia(*tree)) {
    *tree = novo;
    ...
    while (aux != NULL) {
      ...
      if (valor == aux->dado){
        printf("O valor que voc√™ quer inserir j√° existe.\n");
        break;
      }else if(valor < aux->dado){
        aux = aux->esq;
      }else{
...
void remover(NO **tree, int valor){
  ...
  if (aux->esq == NULL && aux->dir == NULL){
    ...
    //remove um n√≥ folha que n√£o √© raiz
...
void mostraAscDesc(NO* tree, int valor) {
  ...
  if (aux->esq == NULL && aux->dir == NULL) {
    printf("O n√≥ n√£o tem descendentes, √© um n√≥ folha");
    return;
  }
...
/* ********************************************************** */
/*      Mostra Profundidade, Altura, Nivel e Grau do nÛ       */
/* ********************************************************** */
...
/* ********************************************************** */
/*             Auxilia a RepresentaÁ„o da Arbore              */
/* ********************************************************** */
